        ...
        >
            {items.map((item, idx) => {
                ...
                >
                    ...
                    <div className="rounded-md w-full p-4 overflow-hidden bg-[#09090B] group-hover:ring-2 ring-violet-500 relative z-20 transition-all duration-500  cursor-pointer">
                        <div className="py-0 lg:py-10 z-50 relative space-y-5 ">
